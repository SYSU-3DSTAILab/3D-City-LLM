...
def main(args):
    ...
    prompt_final_self = """The output must strictly adhere to the following format (where X.X represents a numerical score between 0 and 10, with one decimal place allowed; provide concise justification after rating):
    {
