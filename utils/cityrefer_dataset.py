...
class ReasonSegDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        SCANREFER_TRAIN = json.load(open(os.path.join("/content/drive/MyDrive/City-LLM/data/meta_data/CityLLM_train_all_v2.json"))) 
        SCANREFER_VAL = json.load(open(os.path.join("/content/drive/MyDrive/City-LLM/data/meta_data/CityLLM_val_NO_v1.json"))) 
        ...
        self.scanrefer=scanrefer["val"] # train or val
        self.DC=DC
    ...
    def __getitem__(self, idx):
        ...
        query = "The query is: " + query + "Please provide the degree to which the query matches this object."
