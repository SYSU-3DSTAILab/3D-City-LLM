...
## Train
You can train the 3DCity-LLM with pre-trained LLM backbone. Note that SAM is available at [backbone model](https://drive.google.com/file/d/1shdmFrhzX3QD-8nhF8OV_zkCGWTZU984/view?usp=drive_link).
```
...
## Acknowledgement
3DCity-LLM is built upon [LLaVA](https://github.com/haotian-liu/LLaVA), [Uni3D](https://github.com/baaivision/Uni3D), [SensatUrban](https://github.com/QingyongHu/SensatUrban) and [UrbanBIS](https://vcc.tech/UrbanBIS). 
